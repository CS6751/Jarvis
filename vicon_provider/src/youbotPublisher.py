...
class ViconPublisher:
    def __init__(self, host="10.0.0.102", port=800, \
        x_VICON_name="KUKAyouBot2:main body <t-X>", y_VICON_name="KUKAyouBot2:main body <t-Y>", z_VICON_name="KUKAyouBot2:main body <t-Z>", \
        phi_VICON_name="KUKAyouBot2:main body <a-X>", theta_VICON_name="KUKAyouBot2:main body <a-Y>", psi_VICON_name="KUKAyouBot2:main body <a-Z>"):
